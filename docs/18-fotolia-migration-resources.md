...
| __Media__            |                      |                                                |                                                                                                                                              | 
| [getMediaData](https://us.fotolia.com/Services/API/Rest/Method/getMediaData)     | TBA                  | Return all information about a media           | New bulk metadata API planned to be available in Q2 2019. This will be a single API to replace both `getMediaData` and `getBulkMediaData` | 
| [getBulkMediaData](https://us.fotolia.com/Services/API/Rest/Method/getBulkMediaData) | TBA                  | Return all information about a media           | New bulk metadata API planned to be available in Q2 2019. This will be a single API to replace both `getMediaData` and `getBulkMediaData` | 
...
| search_parameters[gallery_id]                         | Same                                    | Search by gallery                                                                                                                                           | 
...
| search_parameters[filters][license_L:on] <br>search_parameters[filters][license_XL:on] <br>search_parameters[filters][license_XXL:on] <br>search_parameters[filters][license_XXL>25MP:on]      | __search_parameters[filters][area_pixels]__ | Filter by size in megapixels (width * height). In Stock, standard images are always licensed at full resolution | 
