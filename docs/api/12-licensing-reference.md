...
In the following examples, "MyAccessToken" would be substituted with a valid access token generated by your application.

Download of original asset

```
curl "https://stock.adobe.com/Rest/Libraries/Download/62305369/1?token=MyAccessToken"
```

Download of 1600px image

```
curl "https://stock.adobe.com/Rest/Libraries/Download/62305369/1?token=MyAccessToken&size=1600"
```

Download of 1080p rendition of video

```
curl "https://stock.adobe.com/Rest/Libraries/Download/99872034/1?token=MyAccessToken&size=1080"
```
